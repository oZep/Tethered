...
class Game:
    def __init__(self):
        ...
        self.assets = {
            ...
            'player/slide': Animation(load_images('entities/player/slide'), img_dur =1),
            'player/wall_slide': Animation(load_images('entities/player/wall_slide'), img_dur =1),
            'enemy/stun': Animation(load_images('entities/cat/stun'), img_dur =1),
